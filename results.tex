...
\begin{table}[]
\begin{tabular}{l|l|l}
Training set name                                                                                            & Abbreviation & Datasets                                                                                                      \\ \hline
{[}B{]}oats {[}s{]}ailing                                                                                    & BS           & \begin{tabular}[c]{@{}l@{}}Trondheimsfjorden, BoatsClose \\ and BoatsFar\end{tabular}                         \\ \hline
\begin{tabular}[c]{@{}l@{}}{[}B{]}oats {[}s{]}ailing and \\ {[}m{]}oored boats\end{tabular}                  & BSM          & \begin{tabular}[c]{@{}l@{}}Trondheimsfjorden, BoatsClose, \\ BoatsFar, and MooredBoats\end{tabular}           \\ \hline
\begin{tabular}[c]{@{}l@{}}{[}B{]}oats {[}s{]}ailing, \\ {[}m{]}oored boats and\\  {[}h{]}ouses\end{tabular} & BSMH         & \begin{tabular}[c]{@{}l@{}}Trondheimsfjorden, BoatsClose, \\ BoatsFar, MooredBoatsHouses, Houses\end{tabular}
\end{tabular}
\caption{Training sets used to train Yolo and SSD models.}
...
\centering
\begin{tabular}{l|ll}
Model name  & Trained on datasets                        \\ \hline
Yolo$_{\text{BS}}$, SSD$_{\text{BS}}$   & [B]oats [s]ailing                           \\
Yolo$_{\text{BSM}}$, SSD$_{\text{BSM}}$ & [B]oats [s]ailing and [m]oored boats           \\
Yolo$_{\text{BSMH}}$, SSD$_{\text{BSMH}}$ & [B]oats [s]ailing, [m]oored boats and [h]ouses
\end{tabular}
...
Test dataset(s)                                                                               & Yolo$_{\text{BS}}$ & SSD$_{\text{BS}}$ & Yolo$_{\text{BSM}}$ & SSD$_{\text{BSM}}$ & Yolo$_{\text{BSMH}}$ & SSD$_{\text{BSMH}}$ \\ \hline
MooredBoats                                                                              & 0.182              & 0.140             & 0.707               & 0.515              & 0.701                & 0.586               \\ \hline
Trondheimsfjorden                                                                        & 0.885              & 0.860             & 0.900               & 0.750              & 0.908                & 0.876               \\ \hline
\begin{tabular}[c]{@{}l@{}}BoatsClose and\\ BoatsFar\end{tabular}                        & 0.509              & 0.278             & 0.533               & 0.239              & 0.647                & 0.292               \\ \hline
\begin{tabular}[c]{@{}l@{}}BoatsClose, \\ BoatsFar and \\ Trondheimsfjorden\end{tabular} & 0.577              & 0.375             & 0.600               & 0.329              & 0.726                & 0.391              
\end{tabular}
...
The datasets BoatsClose and BoatsFar consists mostly of images taken towards open sea, of boats that are sailing, i.e., the boats are not moored. It is on this dataset the performance differences between Yolo$_{\text{BSM}}$ and Yolo$_{\text{BSMH}}$ and between SSD$_{\text{BSM}}$ and SSD$_{\text{BSMH}}$ differ the most, as can be seen in figure \ref{fig:bcbf_prec}.
...
\subsubsection{Yolo$_{\text{BSM}}$ and Yolo$_{\text{BSMH}}$ on BoatsClose and BoatsFar}
