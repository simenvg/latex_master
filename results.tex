...
\centering
\begin{tabular}{l|l}
Training set                                                                                           & Datasets                                                                                                      \\ \hline
Boats Sailing (BS)                                                                                            & \begin{tabular}[c]{@{}l@{}}Trondheimsfjorden \\ BoatsClose \\ BoatsFar\end{tabular}                         \\ \hline
\begin{tabular}[c]{@{}l@{}}Boats Sailing and \\ Moored boats (BSM) \end{tabular}                            & \begin{tabular}[c]{@{}l@{}}Trondheimsfjorden \\ BoatsClose \\ BoatsFar \\ MooredBoats\end{tabular}           \\ \hline
\begin{tabular}[c]{@{}l@{}}Boats Sailing, Moored boats \\ and  Houses (BSMH) \end{tabular}         & \begin{tabular}[c]{@{}l@{}}Trondheimsfjorden \\ BoatsClose \\ BoatsFar \\ MooredBoatsHouses \\ Houses\end{tabular}
\end{tabular}
...
\newpage 
\noindent
These training sets were used to train three SSD models and three Yolo models. Henceforth these models will be denoted with the training set abbreviation as subscript:  Yolo$_{\text{BS}}$, SSD$_{\text{BS}}$, Yolo$_{\text{BSM}}$, SSD$_{\text{BSM}}$,
Yolo$_{\text{BSMH}}$ and SSD$_{\text{BSMH}}$.


\section{Results Overview}
\label{sec:res_over}

To present an overview of the results two statistics have been used. Average precision is presented in chapter \ref{subsec:ap}, and confusion matrices in chapter \ref{subsec:cm}. Chapter \ref{subsec:main} discusses the most important aspects of these results.

\subsection{Average Precision}¨
\label{subsec:ap}
The average precision of the models on the different test sets is shown in table \ref{ap_tab}.

\begin{table}[h!]
\centering
\begin{tabular}{l|ll|ll|ll}
Test set                                                                               & Yolo$_{\text{BS}}$ & SSD$_{\text{BS}}$ & Yolo$_{\text{BSM}}$ & SSD$_{\text{BSM}}$ & Yolo$_{\text{BSMH}}$ & SSD$_{\text{BSMH}}$ \\ \hline
